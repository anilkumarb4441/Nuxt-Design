<template>
  <div>
    ...
    <div class="col-lg-7 mx-auto">
      ...
      <p>
        <em>
          Ready to take your learning further? Learn to prototype, experiment,
          and iterate to move your ideas forward in our course From Ideas to
          Action. {{ endText }}
        </em>
      </p>
      <div>
      ...
      <div>
        <a href="/resources/articles">
          <b-button class="btn backButton my-5 px-4">
